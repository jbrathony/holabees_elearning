...
function DonateUsBanner(props) {
  ...
  return (
    <div className={classes.donateusroot} ref={elem}>
        ...
        <div className={classes.bannerWrap}>
          <div className={classes.aboutUsBanner}>
            <div className={classes.aboutUsText}>
              ...
              <h1 className={classes.textAboutus}>{t('hosting-landing:donateus_banner')}</h1>
            </div>
          </div>
        </div>
      </Container>
...
DonateUsBanner.propTypes = {
  t: PropTypes.func.isRequired
};

export default withTranslation(['hosting-landing'])(DonateUsBanner);
